...
samtools view -b aln-pe.sam | samtools sort > aln-pe_sorted.bam
samtools index aln-pe_sorted.bam
samtools flagstat aln-pe_sorted.bam > aln-pe.flagstat
samtools idxstats aln-pe_sorted.bam > aln-pe.idxstats
